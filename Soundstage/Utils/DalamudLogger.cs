...
internal class DalamudLogger : ILogger
{
    ...
    readonly SoundstageConfiguration _configuration;

    public DalamudLogger(string name, SoundstageConfiguration configuration, IPluginLog pluginLog)
    {
        _categoryName = name;
...
internal class DalamudLoggerProvider : ILoggerProvider
{
    ...
    public DalamudLoggerProvider(IPluginLog pluginLog, SoundstageConfiguration configuration)
    {
        _pluginLog = pluginLog;
        _configuration = configuration;
    }
...
internal static class DalamudLoggingExtensions
{
    public static ILoggingBuilder AddDalamudLogging(this ILoggingBuilder builder, IPluginLog pluginLog)
    {
        builder.Services.TryAddEnumerable(ServiceDescriptor.Singleton<ILoggerProvider, DalamudLoggerProvider>
            (b => new DalamudLoggerProvider(pluginLog, b.GetRequiredService<SoundstageConfiguration>())));
        return builder;
    }
}
