...
public class LiveSoundstage : IDisposable
{
    ...
    public LiveSoundstage(SoundstageDefinition definition, ILiveObjectService liveObjectService)
    {
        _liveObjectService = liveObjectService;
        Update(definition);
    }

    public void Update(SoundstageDefinition newDefinition)
    {
