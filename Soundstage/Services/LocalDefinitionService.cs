...
/// <summary>
/// Specifies a location in which to automatically show a local Soundstage definition.
/// </summary>
...
/// <summary>
/// Metadata about a local Soundstage definition.
/// </summary>
...
/// <summary>
/// Maintains a list of the user's local Soundstage definitions.
/// </summary>
public interface ILocalDefinitionService
{
    /// <summary>
    /// The directory where the local soundstages are stored, without a trailing slash.
    /// </summary>
    string LocalDefinitionDirectory { get; set; }

    /// <summary>
    /// The full filenames and metadata for the local Soundstage definitions.
    /// </summary>
    IReadOnlyDictionary<string, ILocalDefinitionMetadata> LocalDefinitions { get; }

    /// <summary>
    /// Sets the automatic show conditions for the local soundstage definition at the given full path.
    /// </summary>
    /// <param name="filename">The full path to the Soundstage definition.</param>
    ...
    /// <summary>
    /// Raised when local Soundstage definitions have been added, removed, or changed.
    /// </summary>
...
public class LocalDefinitionService : ILocalDefinitionService, IDisposable
{
    ...
    {
        public SoundstageInfo Info { get; set; }
    ...
    public LocalDefinitionService(ILogger<LocalDefinitionService> logger, SoundstageConfiguration configuration)
    {
        _logger = logger;
    ...
    private void AddOrUpdateMetadata(string filename, SoundstageDefinition definition)
    {
    ...
    private bool TryLoadDefinitionFile(string filename, [NotNullWhen(true)] out SoundstageDefinition? definition)
    {
        ...
        for (int attempt = 0; attempt < 10; attempt++)
        {
            try
            {
                ...
                {
                    definition = JsonSerializer.Deserialize<SoundstageDefinition>(stream, options: SoundstageDefinition.StandardSerializerOptions);
                }
