...
[Serializable]
public class SoundstageConfiguration : IPluginConfiguration
{
    public int Version { get; set; } = 0;

    /// <summary>
    /// The full path, not ending in a slash, to the directory to store the player's local Soundstage definitions in.
    /// </summary>
