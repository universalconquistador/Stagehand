...
The Stagehand API includes methods for querying the local Stage definitions, creating and destroying temporary Stages, and showing and hiding both local and temporary Stages.
