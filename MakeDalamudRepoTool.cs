...
const string IconUrl = "https://github.com/universalconquistador/Stagehand/releases/latest/download/icon.png";
const string DownloadUrl = "https://github.com/universalconquistador/Stagehand/releases/latest/download/latest.zip";
